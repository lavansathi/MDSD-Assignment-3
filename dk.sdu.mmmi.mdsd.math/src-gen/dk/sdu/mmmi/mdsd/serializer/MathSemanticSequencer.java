...
public class MathSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *     Exp.Plus_1_0_0_0 returns Division
	 *     Exp.Minus_1_0_1_0 returns Division
	 *     Factor returns Division
	 *     Factor.Multiply_1_0_0_0 returns Division
	 *     Factor.Division_1_0_1_0 returns Division
	 *
	 * Constraint:
	 *     (left=Factor_Division_1_0_1_0 right=Primary)
	 */
	protected void sequence_Factor(ISerializationContext context, Division semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getFactorAccess().getDivisionLeftAction_1_0_1_0(), semanticObject.getLeft());
	 ...
	 *     Exp.Plus_1_0_0_0 returns Multiply
	 *     Exp.Minus_1_0_1_0 returns Multiply
	 *     Factor returns Multiply
	 *     Factor.Multiply_1_0_0_0 returns Multiply
	 *     Factor.Division_1_0_1_0 returns Multiply
	 *
	 * Constraint:
	 ...
	 *     Factor.Multiply_1_0_0_0 returns LetBinding
	 *     Factor.Division_1_0_1_0 returns LetBinding
	 ...
	 *     Factor.Multiply_1_0_0_0 returns Expression
	 *     Factor.Division_1_0_1_0 returns Expression
	...
	protected void sequence_Primary(ISerializationContext context, Expression semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, MathPackage.Literals.EXPRESSION__EXP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MathPackage.Literals.EXPRESSION__EXP));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getPrimaryAccess().getExpExpParserRuleCall_2_1_0(), semanticObject.getExp());
		feeder.finish();
	}
	 ...
	 *     Factor.Multiply_1_0_0_0 returns MathNumber
	 *     Factor.Division_1_0_1_0 returns MathNumber
	 ...
	 *     Factor.Multiply_1_0_0_0 returns Parenthesis
	 *     Factor.Division_1_0_1_0 returns Parenthesis
	 ...
	 *     Factor.Multiply_1_0_0_0 returns VariableUse
	 *     Factor.Division_1_0_1_0 returns VariableUse
